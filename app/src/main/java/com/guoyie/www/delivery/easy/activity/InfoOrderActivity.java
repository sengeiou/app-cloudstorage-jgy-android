 ...
 * data：2017/12/6
 */
public class InfoOrderActivity extends BaseActivity implements View.OnClickListener, TrantosListAdapter.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener, NRecyclerView.OnLoadMoreListener, InfoOrderListAdapter.OnItemClickListener {
    private ImageView mLeft_back;
    private TextView  mTv_title;
    private ArrayList<CustomTabEntity> mTabEntities = new ArrayList<>();
    private String                     tabTitles[]  = new String[]{"全部", "进行中(3)","已结束"};
    ...
    private void loadData(int type, int page2) {
    ...
    public void onItemClick(View itemView, int position) {
        ...
        startAct(InfoOrderDetailActivity.class);
