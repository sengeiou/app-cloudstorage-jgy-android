 ...
 * data：2017/12/7
 */
public class StoreManagerAdapter extends NAdapter<StoreManagerBean> {
    ...
    @Override
    protected void onBindData(final NRecyclerViewHolder holder, StoreManagerBean s, final int position) {
