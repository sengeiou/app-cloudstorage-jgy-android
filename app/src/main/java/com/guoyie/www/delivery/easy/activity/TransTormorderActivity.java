 ...
 * data：2017/12/6
 */
public class TransTormorderActivity extends BaseActivity implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, NRecyclerView.OnLoadMoreListener, TrantosListAdapter.OnItemClickListener {

    private ImageView                 mLeft_back;
    private TextView                  mTv_title;
    private ArrayList<CustomTabEntity> mTabEntities = new ArrayList<>();
    private String                     tabTitles[]  = new String[]{"全部", "进行中(3)","未通过","已完成"};
    ...
    public void onItemClick(View itemView, int position) {
        ...
        startAct(TransTormDetailActivity.class);
