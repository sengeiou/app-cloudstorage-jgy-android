...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_tablayout, 1);
        sViewsWithIds.put(R.id.tab_layout, 2);
        sViewsWithIds.put(R.id.fl_body, 3);
    }
    // views
    @NonNull
    public final android.widget.FrameLayout flBody;
    @NonNull
    public final android.widget.LinearLayout llTablayout;
    @NonNull
    ...
    public ActivityMainBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.flBody = (android.widget.FrameLayout) bindings[3];
        this.llTablayout = (android.widget.LinearLayout) bindings[1];
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.guoyie.www.delivery.easy.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.guoyie.www.delivery.easy.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
